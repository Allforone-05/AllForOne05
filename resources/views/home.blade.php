...
<hr>
   ...
   <div class="accordion text-left animate__animated animate__slideInDown" id="accordionExample">
    <div class="card">
    ...
    <div class="card text-left animate__animated animate__slideInDown">
...
@else
    <p class="text-center animate__animated animate__slideInDown animate__animated animate__pulse">No hay cursos destacados disponibles en este momento.</p>
@endif
        ...
        <div class="container text-center animate__animated animate__slideInDown">
            <h2>Últimos Comentarios</h2>
            <div class="row">
                @foreach ($comments->groupBy('user_id') as $commentGroup)
                    @foreach ($commentGroup->take(1) as $comment)
                        <div class="col-md-3 mb-4">
                            <div class="card">
                                <div class="card-header">
                                    @if ($comment->user->profile_photo)
                                    <img src="{{ asset('images/' . $comment->user->profile_photo) }}" alt="Foto de perfil" class="card-img-top img-thumbnail">
                                    @else
                                    <i class="fa fa-user fa-3x m-3 text-muted"></i>
                                    @endif
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <small class="text-muted">Comentario en: {{ $comment->course->titulo }}</small>
                                </div>
                            </div>
                        </div>
                    @endforeach
